...
export default function TimeHeatmap({ activities }) {
  ...
  return (
    <div>
      <h2 className="text-lg font-semibold mb-3 text-gray-200">Time-of-day heatmap<InfoTooltip text="Shows the times of day and week when you ride most often. Darker cells = more activities." /></h2>
